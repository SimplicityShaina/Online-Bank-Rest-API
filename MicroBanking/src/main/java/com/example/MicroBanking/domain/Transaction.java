package com.example.MicroBanking.domain;
...
public class Transaction {
	...
	//@Range(min=100,max=2000,message=" balance should be between 100 to 2000")
	private double depositamt;
	
	//@Range(max=2000,min=200,message="withdraw only up to 2000")
